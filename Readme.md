...
I will most probably not be able to continue working on this project (lack of time).
At this moment, this project is usable, and has been successfully used for debugging **C** programs for **ARM Cortex-M** microcontrollers, with the **blackmagic** probe.

If you decide to give this program a try, I hope that you will find it useful!

Please, do report any issues that you have on the github page of this project. I will try to address any issues, but I can make no promises. Still, it is best to be aware of any known issues.
Thank you!
